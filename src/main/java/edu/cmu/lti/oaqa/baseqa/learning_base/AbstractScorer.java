...
/**
 * An abstract class for the interface {@link Scorer} that can be configured using
 ...
 */
public abstract class AbstractScorer<T> extends ConfigurableProvider implements Scorer<T> {
}