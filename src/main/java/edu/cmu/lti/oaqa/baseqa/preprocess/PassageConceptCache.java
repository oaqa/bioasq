...
/**
 * <p>
 *   A {@link JCasAnnotator_ImplBase} that scans through all passages in each input {@link JCas}
 *   and uses a list of cacheable {@link ConceptProvider}s and {@link SynonymExpansionProvider}s to
 *   annotate the passages.
 * </p>
 * <p>
 *   The use of this class and {@link QuestionConceptCache} is optional.
