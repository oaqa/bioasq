...
/**
 * An interface that modifies existing {@link edu.cmu.lti.oaqa.type.answer.CandidateAnswerVariant}
 * for certain types of inputs, pluggable into
 * {@link edu.cmu.lti.oaqa.baseqa.answer.modify.CavModificationManager} to get executed.
 *
 * @see edu.cmu.lti.oaqa.baseqa.answer.modify.CavModificationManager
 * @see AnswerModifier
 *
